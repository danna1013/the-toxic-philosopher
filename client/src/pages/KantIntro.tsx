...
const script = [
  { 
    text: "我，康德，进行了一场哲学的'哥白尼革命'。", 
    image: "/kant-scene-1-white.png",
    imageAlt: "哥白尼革命",
  },
  { 
    text: "让理性为自然立法，让人为道德立法。", 
    image: "/kant-scene-2-white.png",
    imageAlt: "立法",
  },
  { 
    text: "我一生敬畏的，唯有头顶的星空，和心中的道德律。", 
    image: "/kant-scene-3-white.png",
    imageAlt: "星空与道德律",
  },
];

export default function KantIntro() {
  const [, setLocation] = useLocation();
  const [currentScene, setCurrentScene] = useState(0);

  // 跳过按钮
  const handleSkip = () => {
    setLocation('/chat/kant');
  };
