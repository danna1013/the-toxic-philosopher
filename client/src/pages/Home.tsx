...
export default function Home() {
  ...
  return (
    <div className={`min-h-screen bg-white flex flex-col relative overflow-hidden transition-opacity duration-1000 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
      {/* 导航栏 */}
      ...
      >
        ...
        <div className="text-center mb-12 md:mb-16 lg:mb-20 max-w-6xl animate-fade-in-up">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-black tracking-tight leading-[1.1] mb-4 md:mb-6">
            真相往往不太礼貌
          </h1>
          
          <h2 className="text-xl md:text-2xl lg:text-3xl font-light text-gray-600 tracking-tight leading-[1.2] animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            但总比谎言有用
          </h2>
        </div>
