 ...
 * 验证体验码
 */
export function verifyCode(code: string): { valid: boolean; message: string; data?: AccessCode } {
  ...
  if (accessCode.status === 'used' && accessCode.currentUses >= accessCode.maxUses) {
